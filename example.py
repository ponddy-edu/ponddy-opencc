...
if __name__ == '__main__':
    ...
    words_t = '後臺有個很醜的人，他開車從南迴到台東，中途遇到一隻羊，捲了一卷煙給羊抽，他看了看手錶，發現時間差不多，就驅車前往萬里長城吃麵條配雲吞湯，然後什麼事情都沒幹就回家睡覺了。'
    words_s = '后台有个很丑的人，他开车从南回到台东，中途遇到一只羊，卷了一卷烟给羊抽，他看了看手表，发现时间差不多，就驱车前往万里长城吃面条配云吞汤，然后什么事情都没干就回家睡觉了。'

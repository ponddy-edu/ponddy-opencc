...
if __name__ == '__main__':
    ...
    words_t = '肌肉细胞因为形态细长且成纤维状，所以也叫肌肉纤维。肌肉纤维由肌内膜所包覆成为肌束，一束束的肌束再组成肌肉。肌肉纤维由肌原纤维构成，肌原纤维内包含了肌小节，它是肌肉进行收缩的最小功能性单位。'
    words_s = '肌肉细胞因为形态细长且成纤维状，所以也叫肌肉纤维。肌肉纤维由肌内膜所包覆成为肌束，一束束的肌束再组成肌肉。肌肉纤维由肌原纤维构成，肌原纤维内包含了肌小节，它是肌肉进行收缩的最小功能性单位。'
